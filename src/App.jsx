...
function App() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-[1fr_auto_auto] md:grid-rows-[1fr_auto] h-screen w-screen overflow-hidden bg-felt text-white">
      ...
      <div className="col-start-1 row-start-1 md:col-start-1 md:col-span-2 md:row-start-1 relative z-0 shadow-[inset_0_0_100px_rgba(0,0,0,0.5)] flex flex-col min-h-0">
         ...
         <div className="flex-1 flex flex-col items-center justify-center relative min-h-0 overflow-hidden">
            ...
            <div className="absolute top-1/4 right-1/4 transform rotate-12 flex -space-x-4 sm:-space-x-10 shadow-xl scale-50 sm:scale-100 max-w-[50%]">
